...
Tags: empty paragraphs, empty paragraph tags, empty p tags, remove
...
p Squirrel removes all empty paragraph elements from your site.

= How does p Squirrel work? =

p Squirrel uses JavaScript and JQuery to find and remove empty paragraph elements.
